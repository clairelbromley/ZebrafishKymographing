function cutMetadata = importCutMetadata(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   CUTMETADATA = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   CUTMETADATA = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   cutMetadata = importfile('171_0.txt', 1, 11);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/11/22 21:25:53
