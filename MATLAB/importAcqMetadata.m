function acqupara = importAcqMetadata(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   ACQUPARA = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   ACQUPARA = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   acqupara = importfile('171acqupara.txt', [3,9,14], [4,10,19]);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2015/11/22 21:50:43
