...
% Last Modified by GUIDE v2.5 15-Feb-2016 21:00:58
...
function spacingOrNumberEdit_Callback(hObject, eventdata, handles)
% hObject    handle to spacingOrNumberEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of spacingOrNumberEdit as text
%        str2double(get(hObject,'String')) returns contents of spacingOrNumberEdit as a double


% --- Executes during object creation, after setting all properties.
function spacingOrNumberEdit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to spacingOrNumberEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
